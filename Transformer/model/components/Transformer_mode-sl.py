...
class Encoder(nn.Module):
    def __init__(
        ...
        #         [
        #             EncoderLayer(
        #                 AttentionLayer(ProbAttention(False, factor=5, attention_dropout=0.1, output_attention=False), 
        ...
        #         ],
        #         [
        #             ConvLayer(256) for l in range(e_layers-1)
        #         ] if distil else None,
    ...
    def forward(self, src, src_mask, src_key_padding_mask):
        ...
        input = self.pos_embedding(input) + self.value_embedding(input)
...
class Trajectory_Decoder(Decoder):
    ...
    def forward(
        ...
        #output = self.transformer_decoder(
        #    self.pos_encoder(self.input_fc(tgt)),
        #    memory,
        #    tgt_mask=tgt_mask,
        #    memory_key_padding_mask=memory_key_padding_mask)
