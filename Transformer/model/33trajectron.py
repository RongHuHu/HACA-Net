...
class Trajectron(object):
    ...
    def set_environment(self, env):
        ...
        for node_type in env.NodeType:
            ...
            #if node_type == "PEDESTRIAN": # "VEHICLE":
            #    continue
            if node_type in self.pred_state.keys():
                ...
                #print('self.node_models_dict[node_type]',self.node_models_dict[node_type])
    ...
    def train_loss(self, batch, node_type):
        (_, x_t, y_t, x_st_t, y_st_t, neighbors_data_st, neighbors_edge_value, robot_traj_st_t, lanes, map) = batch
    ...
    def predict(
        ...
        for node_type in self.env.NodeType:
            ...
            (_, x_t, y_t, x_st_t, y_st_t, neighbors_data_st, neighbors_edge_value, robot_traj_st_t,
